module Internal.Voicing.FourPart.Classical exposing
    ( firstInversion
...
import Internal.ChordClass as ChordClass exposing (ChordClass(..))
import Internal.Interval as Interval exposing (IntervalNumber(..))
...
import Internal.Voicing.Util as VoicingUtil
