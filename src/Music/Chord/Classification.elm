...
## Classifying chords exhaustively is hard and weird!
...
This makes classifying chords a complicated topic, because some categories that are normally isolated from each other can potentially interact in unspecified ways.

For instance, non-tertian "added-tone" chords and "altered extensions" on 7th chords belong to separate models of chord categorization. Can added-tone chords like m6 have extensions, as in a m6(♭13)? I have personally never seen such a chord, but I have also never seen a rule that says why it cannot be done!

This `Classification` type is my best attempt to codify the taxonomy I'm aware of into a type you can destructure for your own purposes. Just be aware that, for the reasons I've described, it can represent some combinations that are unusual but not clearly invalid. Use your judgment as to which of these you want to handle, and which you want to ignore.
